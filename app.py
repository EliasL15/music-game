...
def run_game(lobby_code):
    ...
    # Announce game is about to start
    socketio.emit('game_starting', {'message': 'Game is starting...'}, room=lobby_code)
    socketio.sleep(3)  # Give clients time to transition
...
def start_game():
    ...
    socketio.sleep(2)  # Add small delay before starting game
